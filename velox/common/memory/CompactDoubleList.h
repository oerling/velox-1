...
class CompactDoubleList {
 public:
  ...
  // Updates the next pointer to be 'next' and sets 'next's previous pointer to 'this'. The use case is taking the head of a free list block without a full remove of block plus reinsert of the remainder of the block.
