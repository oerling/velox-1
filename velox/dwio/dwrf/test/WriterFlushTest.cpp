...
class MockMemoryPool : public velox::memory::MemoryPool {
 public:
  ...
  bool allocateNonContiguous(
      ...
      velox::memory::MemoryAllocator::Allocation& out,
      velox::memory::MachinePageCount minSizeClass = 0) override {
    VELOX_UNSUPPORTED("allocateNonContiguous unsupported");
  }

  void freeNonContiguous(
      velox::memory::MemoryAllocator::Allocation& allocation) override {
  ...
  bool allocateContiguous(
      velox::memory::MachinePageCount numPages,
      velox::memory::MemoryAllocator::ContiguousAllocation& allocation)
      override {
