...
#include "velox/benchmark/QueryBenchmarkBase.cpp"
...
void QueryBenchmarkBase::shutdown() {
  ...
  std::pair<std::unique_ptr<TaskCursor>, std::vector<RowVectorPtr>> QueryBenchmarkBase::run(
  ...
  void QueryBenchmarkBase::runMain(std::ostream& out, RunStats& runStats) {
