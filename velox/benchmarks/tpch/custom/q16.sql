...
select
	...
	p.type,
	p.size,
	count(distinct ps.suppkey) as local_pnb2dw1.oerling_supplier_3k_nz_cnt
from
	local_pnb2dw1.oerling_part_3k_nzsupp as ps,
	local_pnb2dw1.oerling_part_3k_nz as p
where
	p.local_pnb2dw1.oerling_part_3k_nzkey = ps.partkey
...
group by
	...
	p.size
order by
	local_pnb2dw1.oerling_supplier_3k_nz_cnt desc,
	p.brand,
	p.type,
	p.size;
