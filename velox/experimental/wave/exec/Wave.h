...
class WaveStream {
 public:
  ...
  /// Sets nullability of a source column. This is runtime, since may depend on the actual presence of nulls in the source, e.g. file. Nullability defaults to nullable.
