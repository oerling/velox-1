...
namespace facebook::velox::wave {
  ...
  std::vector <std::unique_ptr<WaveSplitReaderFactory>> WaveSplitReader::factories_;

//static
void WaveSplitReader::registerFactory(std::unique_ptr<WaveSplitReaderFactory> factory) {
