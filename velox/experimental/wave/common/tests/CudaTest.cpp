...
class RoundtripThread {
 public:
  ...
  // Returns number of streams, number of items per stream for multi-stream execution over 'kb' KB of input. Ensures enough streams and events in 'streams_' and 'events_'. Take min 4KB per TB.
