...
#define CUDA_CHECK_FATAL(e) ::facebook::velox::wave::cudaCheckFatal(e, __FILE__, __LINE__)
...
namespace { \
static bool func##_reg = registerKernel(name, reinterpret_cast<const void*>(func)); \
}
