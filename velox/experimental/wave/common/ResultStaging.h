...
struct LaunchParams {
  ...
  // Arena for decode and program launch param blocks. Lifetime of allocations is a wave in WaveStream, typical size under 1MB, e.g. 1K blocks with 1K of params.
