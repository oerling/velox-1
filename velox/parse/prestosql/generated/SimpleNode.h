...
protected: 
  ...
  void*              value  = nullptr;
//int                numChildren;
  SqlParser*    parser = nullptr;
  int                id = 0;

public: 
           SimpleNode(int id);
           SimpleNode(SqlParser* parser, int id);
  virtual ~SimpleNode();
...
//#fi
  ...
  virtual void           jjtChildrenAccept(SqlParserVisitor *visitor, void * data) const;
  virtual void           jjtChildAccept(int childNo, SqlParserVisitor *visitor, void * data) const;
...
#endif
/* JavaCC - OriginalChecksum=157085b5e6347a96f347181cb2f037f4 (do not edit this line) */
