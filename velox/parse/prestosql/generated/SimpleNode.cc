...
SimpleNode::SimpleNode(SqlParser *parser, int id) :
     parser(parser), id(id) 
{
}
...
void  SimpleNode::jjtAccept(SqlParserVisitor *visitor, void * data) const
{
    return visitor->visit(this, data);
}

void SimpleNode::jjtChildrenAccept(SqlParserVisitor *visitor, void * data) const {
    for (int i = 0; i < children.size(); ++i) {
      children[i]->jjtAccept(visitor, data);
    }
}

void SimpleNode::jjtChildAccept(int childNo, SqlParserVisitor *visitor, void * data) const {
...
/* JavaCC - OriginalChecksum=bc42fbad4598399196a226befe970d55 (do not edit this line) */
