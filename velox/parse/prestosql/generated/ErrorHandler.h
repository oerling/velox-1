...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class SqlParser;
  class ErrorHandler {
    friend class SqlParserTokenManager;
  ...
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, const JJString& errorAfter, JJChar curChar, SqlParserTokenManager* token_manager) {
       ...
       virtual void lexicalError(const JJString& errorMessage, SqlParserTokenManager* token_manager) {
...
/* JavaCC - OriginalChecksum=8152b396bd22366a93f34100fea6b633 (do not edit this line) */
